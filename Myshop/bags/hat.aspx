...
<div class="hatwrap">
    <div id="hattop" style="text-align: left">
        ...
        <div id="hatright">
               <div id="rigtophat" style="text-align: left; width:200px;height: 25px;"> &nbsp; 热门七天无理由退换</div>
               <div id="rigbottomhat" style="text-align: center">
                   ...
                   <ItemTemplate>
                         <table style="width:150px">
                             ...
                             <tr>
                                 <td style="font-size: 11px; color: gray;text-decoration:line-through"><%# Eval("jg","{0:c2}") %></td>
                             </tr>
                             <tr>
