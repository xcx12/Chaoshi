...
public partial class hat_hat : System.Web.UI.Page
{
    Hashtable hashCar;
    ...
    protected void bind()
    {
        ...
        SqlCommand cmd = new SqlCommand("select spmc,pic,jg,discount,spbh from sp where bz='rmx'", cn);
        cn.Open();
    ...
    protected void bind1()
    {
        ...
        SqlCommand cmd1 = new SqlCommand("select spmc,pic,jg,discount,spbh from sp where bz='tjb'", cn1);
        cn1.Open();
