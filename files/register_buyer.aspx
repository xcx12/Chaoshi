<%@ Page Language="C#" AutoEventWireup="true" CodeFile="register_buyer.aspx.cs" Inherits="files_register_buyer" %>
             ...
             <table style="width:100%">
                 <tr>
                     <td colspan="2" style="background-color: #ff9900">
                         <span style="font-weight: bold; font-size: 16pt; color: white">买家信息</span></td>
                 </tr>
             </table>
             <div id="detail">
                 ...
                 <tr>
                     ...
                     <td style="text-align: left">
                         ...
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="cardid"
                             ErrorMessage="证件号码必须填写">*</asp:RequiredFieldValidator></td>
                 </tr>
                 <tr>
                     <td style="text-align: right">
                         邮编：</td>
