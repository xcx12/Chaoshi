                 ...
                 <div id="clobtml">
                      <div class="clobtm1">
                          <div class="clobtmbg" style="text-align: left">
                              女装特色市场--原创推荐区</div>
                              <div id="btmad1"></div>
                          <asp:Label ID="Label1" runat="server" CssClass="cload" Text="什么是独一无二？原创"></asp:Label>
                      ...
                      <div class="clobtm1">
                           <div class="clobtmbg">
                               精品区--混搭流行馆</div>
                               <div id="btmad2"></div>
                          <asp:Label ID="Label2" runat="server" CssClass="cload" Text="御寒新主意，长款加厚毛衣"></asp:Label>
                      ...
                      <div class="clobtm1"><div class="clobtmbg">
                          精品区--日韩馆</div>
                          <div id="btmad3"></div>
                          <asp:Label ID="Label3" runat="server" CssClass="cload" Text="羽绒服让你这个冬天不怕冷"></asp:Label>
